...
var file_proto_tally_v1_board_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6d, 0x6f, 0x76, 0x65, 0x73, 0x22, 0x5a, 0x0a, 0x10, 0x56,
	0x6f, 0x74, 0x65, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x08,
	0x66, 0x75, 0x6e, 0x5f, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e,
	0x2e, 0x74, 0x61, 0x6c, 0x6c, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x07,
	0x66, 0x75, 0x6e, 0x56, 0x6f, 0x74, 0x65, 0x22, 0x8a, 0x01, 0x0a, 0x11, 0x56, 0x6f, 0x74, 0x65,
	...
	0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x29, 0x0a, 0x08, 0x66, 0x75, 0x6e,
	0x5f, 0x76, 0x6f, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x74, 0x61,
	0x6c, 0x6c, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x07, 0x66, 0x75, 0x6e,
	0x56, 0x6f, 0x74, 0x65, 0x22, 0x7b, 0x0a, 0x04, 0x47, 0x61, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x05,
	...
	0x6e, 0x22, 0x8b, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x0a,
	0x04, 0x67, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x74, 0x61,
	0x6c, 0x6c, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x04, 0x67, 0x61, 0x6d,
	...
	0x28, 0x03, 0x52, 0x0b, 0x67, 0x61, 0x6d, 0x65, 0x73, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x64, 0x2a,
	...
	0x4c, 0x54, 0x59, 0x5f, 0x48, 0x41, 0x52, 0x44, 0x10, 0x03, 0x2a, 0x73, 0x0a, 0x04, 0x56, 0x6f,
...
var file_proto_tally_v1_board_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_proto_tally_v1_board_proto_goTypes = []interface{}{
	...
	(Vote)(0),                    // 3: tally.v1.Vote
	(*Cell)(nil),                 // 4: tally.v1.Cell
	(*Board)(nil),                // 5: tally.v1.Board
	(*Instruction)(nil),          // 6: tally.v1.Instruction
	(*GetHintRequest)(nil),       // 7: tally.v1.GetHintRequest
	(*GetHintResponse)(nil),      // 8: tally.v1.GetHintResponse
	(*GetSessionRequest)(nil),    // 9: tally.v1.GetSessionRequest
	(*RestartGameRequest)(nil),   // 10: tally.v1.RestartGameRequest
	(*NewGameRequest)(nil),       // 11: tally.v1.NewGameRequest
	(*RestartGameResponse)(nil),  // 12: tally.v1.RestartGameResponse
	(*GetSessionResponse)(nil),   // 13: tally.v1.GetSessionResponse
	(*NewGameResponse)(nil),      // 14: tally.v1.NewGameResponse
	(*SwipeBoardRequest)(nil),    // 15: tally.v1.SwipeBoardRequest
	(*SwipeBoardResponse)(nil),   // 16: tally.v1.SwipeBoardResponse
	(*Coordinate)(nil),           // 17: tally.v1.Coordinate
	(*Indexes)(nil),              // 18: tally.v1.Indexes
	(*SelectionCoordinates)(nil), // 19: tally.v1.SelectionCoordinates
	(*CombineCellsRequest)(nil),  // 20: tally.v1.CombineCellsRequest
	(*CombineCellsResponse)(nil), // 21: tally.v1.CombineCellsResponse
	(*VoteBoardRequest)(nil),     // 22: tally.v1.VoteBoardRequest
	(*VoteBoardResponse)(nil),    // 23: tally.v1.VoteBoardResponse
	(*Game)(nil),                 // 24: tally.v1.Game
	(*Session)(nil),              // 25: tally.v1.Session
}
var file_proto_tally_v1_board_proto_depIdxs = []int32{
	4,  // 0: tally.v1.Board.cells:type_name -> tally.v1.Cell
	0,  // 1: tally.v1.Instruction.swipe:type_name -> tally.v1.SwipeDirection
	18, // 2: tally.v1.Instruction.combine:type_name -> tally.v1.Indexes
	6,  // 3: tally.v1.GetHintResponse.instructions:type_name -> tally.v1.Instruction
	...
	5,  // 6: tally.v1.RestartGameResponse.board:type_name -> tally.v1.Board
	25, // 7: tally.v1.GetSessionResponse.session:type_name -> tally.v1.Session
	5,  // 8: tally.v1.NewGameResponse.board:type_name -> tally.v1.Board
	0,  // 9: tally.v1.SwipeBoardRequest.direction:type_name -> tally.v1.SwipeDirection
	5,  // 10: tally.v1.SwipeBoardResponse.board:type_name -> tally.v1.Board
	17, // 11: tally.v1.SelectionCoordinates.coordinate:type_name -> tally.v1.Coordinate
	18, // 12: tally.v1.CombineCellsRequest.indexes:type_name -> tally.v1.Indexes
	17, // 13: tally.v1.CombineCellsRequest.coordinate:type_name -> tally.v1.Coordinate
	5,  // 14: tally.v1.CombineCellsResponse.board:type_name -> tally.v1.Board
	3,  // 15: tally.v1.VoteBoardRequest.fun_vote:type_name -> tally.v1.Vote
	3,  // 16: tally.v1.VoteBoardResponse.fun_vote:type_name -> tally.v1.Vote
	5,  // 17: tally.v1.Game.board:type_name -> tally.v1.Board
	24, // 18: tally.v1.Session.game:type_name -> tally.v1.Game
	11, // 19: tally.v1.BoardService.NewGame:input_type -> tally.v1.NewGameRequest
	7,  // 20: tally.v1.BoardService.GetHint:input_type -> tally.v1.GetHintRequest
	10, // 21: tally.v1.BoardService.RestartGame:input_type -> tally.v1.RestartGameRequest
	9,  // 22: tally.v1.BoardService.GetSession:input_type -> tally.v1.GetSessionRequest
	15, // 23: tally.v1.BoardService.SwipeBoard:input_type -> tally.v1.SwipeBoardRequest
	20, // 24: tally.v1.BoardService.CombineCells:input_type -> tally.v1.CombineCellsRequest
	22, // 25: tally.v1.BoardService.VoteBoard:input_type -> tally.v1.VoteBoardRequest
	14, // 26: tally.v1.BoardService.NewGame:output_type -> tally.v1.NewGameResponse
	8,  // 27: tally.v1.BoardService.GetHint:output_type -> tally.v1.GetHintResponse
	12, // 28: tally.v1.BoardService.RestartGame:output_type -> tally.v1.RestartGameResponse
	13, // 29: tally.v1.BoardService.GetSession:output_type -> tally.v1.GetSessionResponse
	16, // 30: tally.v1.BoardService.SwipeBoard:output_type -> tally.v1.SwipeBoardResponse
	21, // 31: tally.v1.BoardService.CombineCells:output_type -> tally.v1.CombineCellsResponse
	23, // 32: tally.v1.BoardService.VoteBoard:output_type -> tally.v1.VoteBoardResponse
